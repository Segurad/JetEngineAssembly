...
/**
 *  @author Rob Camick
 *  {@link https://tips4java.wordpress.com/2009/05/23/text-component-line-number/}
	...
	implements CaretListener, DocumentListener, PropertyChangeListener
{
	...
	public TextLineNumber(JTextComponent component, int minimumDisplayDigits)
	{
		...
		setBorderGap( 5 );
		setForeground(ColorSet.boxTextColor);
		setCurrentLineForeground(ColorSet.lineMarker);
		setDigitAlignment( RIGHT );
		setMinimumDisplayDigits( minimumDisplayDigits );
		setBackground(ColorSet.boxInColor);
